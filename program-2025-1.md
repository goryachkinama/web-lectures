# Группы 2207а, 2207б, 2207в, 2207г, 2307са, 2307сб, 2307св
...
* CSS
    ...
    * [Лекция 4. CSS для продолжающих: блочная верстка (grid, flex), анимация](https://dmitryweiner.github.io/web-lectures/Basic%20-%20CSS.html#/51)
* JavaScript
...
* Node.js и работа с библиотеками
    ...
    * [Лекциb 10-11. Node.js](https://dmitryweiner.github.io/web-lectures/Basic%20-%20Nodejs.html)
    * [Лекция 12. NPM](https://dmitryweiner.github.io/web-lectures/Basic%20-%20NPM.html)
* TypeScript
    * [Лекциb 13-14. TypeScript](https://dmitryweiner.github.io/web-lectures/Basic%20-%20TypeScript.html)
* React.js
    * [Лекция 15. Введение во фреймворк React.js](https://dmitryweiner.github.io/web-lectures/React%20-%20Basic.html)
    * [Лекция 16. Стили, картинки и CSS-препроцессоры](https://dmitryweiner.github.io/web-lectures/React%20-%20Styles%20and%20assets.html#/)
    * [Лекция 17. Функциональные компоненты и хуки](https://dmitryweiner.github.io/web-lectures/React%20-%20Hooks.html)
    * [Лекция 18. Формы и контролы](https://dmitryweiner.github.io/web-lectures/React%20-%20Form%20controls.html).
...
[Часть 1. Введение в синтаксис:](src/labs/lab_js_about.md)
...
[Часть 2. Функции:](src/labs/lab_js_func.md)
...
[Часть 1. Массивы:](src/labs/lab_js_arr.md)

* Задача 1
* Задача 2
* Задача 3

[Часть 2. Генераторы, математика, Map и Set в JavaScript:](src/labs/lab_js_maths.md)
...
[JavaScript и асинхронный код](src/labs/lab_js_async.md)
...
[Прогноз погоды](/src/labs/lab_forecast.md)

* Задание. Прогноз погоды

### 8. JavaScript: работа с DOM, Local Storage и Cookies

[Оживляем список дел: прикручиваем JS](src/labs/lab_js_todo_list.md)
...
[Введение во фреймворк React](src/labs/lab_react.md)
...
[Функциональные компоненты и хуки](src/labs/lab_react_hooks.md)
...
[Работа с контролами (элементами управления)](src/labs/lab_react_forms.md)

* Задание по формам
* Задание на валидацию

[Запросы в сеть](src/labs/lab_react_network.md)
